      ...
      <div class="container">
        ...
        <div class="row no-gutters">
          ...
          <div class="image col-xl-5 d-flex align-items-stretch justify-content-center order-1 order-lg-2" data-aos="fade-left" data-aos-delay="100">
            <?= Html::img('@web/Appland/assets/img/features.svg',['class' => 'img-fluid']) ?>
          </div>
        </div>
      ...
      <div class="container">
        ...
        <div class="row content">
          <div class="col-md-4" data-aos="fade-right">
            <?= Html::img('@web/Appland/assets/img/details-1.png',['class' => 'img-fluid']) ?>
          </div>
        ...
        <div class="row content">
          <div class="col-md-4 order-1 order-md-2" data-aos="fade-left">
            <?= Html::img('@web/Appland/assets/img/details-2.png',['class' => 'img-fluid']) ?>
          </div>
        ...
        <div class="row content">
          <div class="col-md-4" data-aos="fade-right">
            <?= Html::img('@web/Appland/assets/img/details-3.png',['class' => 'img-fluid']) ?>
          </div>
